...
import MyPicture from "../../public/ProfilePic.jpeg";
          ...
          <div className="order-1 md:gap-y-20 md:pt-0 pt-4 mt-10">
            <Slide delay={0.14}>
              ...
              <p className={"text-gray-200/80"}>
                A dedicated full-stack engineer based in Bhubaneswar, Odisha,
                specializing in building robust web applications with modern
                technologies. I excel in designing and maintaining both frontend
                and backend systems to deliver exceptional user experiences. My
                expertise lies in crafting dynamic interfaces and efficient
                server-side logic with optimized code. Utilizing the latest
